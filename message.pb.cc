...
const ::google::protobuf::Message::ClassData* Person_PhoneNumber::GetClassData() const {
  return &_class_data_;
}
...
::_pbi::CachedSize* Person_PhoneNumber::AccessCachedSize() const {
...
const ::google::protobuf::Message::ClassData* AddressBook::GetClassData() const {
  return &_class_data_;
}
...
::_pbi::CachedSize* AddressBook::AccessCachedSize() const {
  return &_impl_._cached_size_;
}
